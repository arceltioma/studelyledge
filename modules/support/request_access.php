...
studelyEnforceAccess($pdo, 'support_create_page');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $successMessage = 'Demande d’accès enregistrée.';
    } catch (Throwable $e) {
...
$pageSubtitle = 'Créer une demande d’accès ou d’évolution de droits.';
        ...
        <div class="form-card">
            ...
            <form method="POST">
                ...
                <div class="btn-group" style="margin-top:20px;">
                    <button type="submit" class="btn btn-outline">Envoyer la demande</button>
                    <a href="<?= e(APP_URL) ?>modules/admin/support_requests.php" class="btn btn-secondary">Retour</a>
                </div>
            </form>
        </div>
