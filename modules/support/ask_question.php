...
$pdo = getPDO();
$pagePermission = 'support_ask_question';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        logUserAction(
            ...
            'support_request',
            $requestId,
            'Question support créée'
        );

        $successMessage = 'Ta question a bien été envoyée.';
        $subject = '';
        $message = '';
        $priority = 'normal';
...
<div class="layout">
    ...
    <div class="main">
        <?php render_app_header_bar('Poser une question', 'Créer une demande d’aide ou de clarification fonctionnelle.'); ?>
        ...
        <div class="dashboard-grid-2">
            ...
            <div class="card">
                ...
                <div class="dashboard-note">
                    Une bonne question précise :
                    le contexte, le bloc concerné, l’objectif, et ce qui te manque pour avancer.
                </div>
            </div>
        </div>
